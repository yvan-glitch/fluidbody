...
export const PILIER_CONTENT = {
  fr: {
    ...
    p9: {
      ...
      medical_disclaimer: "Ce contenu est informatif et ne remplace pas un avis médical. Si tu rencontres des symptômes inhabituels ou des douleurs persistantes, consulte ton médecin ou un professionnel de santé. Le Pilates est un complément à un suivi médical adapté, pas un substitut.",
      anatomy: [
  ...
  en: {
    ...
    p9: {
      ...
      medical_disclaimer: "This content is informational and does not replace medical advice. If you experience unusual symptoms or persistent pain, consult your doctor or a healthcare professional. Pilates complements a tailored medical follow-up; it is not a substitute.",
      anatomy: [
