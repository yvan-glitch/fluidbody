...
export const T = {
  fr: {
    ...
    hk_sub: "Autoriser l'accès à HealthKit pour synchroniser tes séances, ta fréquence cardiaque et tes mouvements.",
  ...
  en: {
    ...
    hk_sub: 'Allow HealthKit access to sync your workouts, heart rate, and movement.',
    hk_connect: 'CONNECT',
