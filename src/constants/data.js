...
export const T = {
  fr: {
    ...
    profil_donnees_title: 'Confidentialité', profil_donnees_desc: 'La majorité de vos données restent sur votre appareil (séances, progression, préférences). Si vous créez un compte, votre email, votre prénom et votre progression sont synchronisés avec notre backend Supabase (UE) pour vous permettre de retrouver vos données sur un autre téléphone. Les rapports de plantage anonymisés sont envoyés à Sentry, et les abonnements transitent par RevenueCat/Apple. Nous ne pratiquons aucun tracking publicitaire.', profil_donnees_local: 'Séances et progression stockées localement', profil_donnees_no_tracking: 'Aucun tracking publicitaire', profil_donnees_healthkit: 'HealthKit : lecture (FC, calories), écriture des séances Pilates',
    ...
    a11y_close_paywall: 'Fermer le paywall',
    a11y_clear_search: 'Effacer la recherche',
    profil_signout: 'Se déconnecter',
    coach_modal_close: 'Fermer',
    profile_edit_close: 'Fermer',
    error_boundary_title: 'Oups — une erreur est survenue',
    error_boundary_sub: 'Relance l\'app ou recharge JavaScript.',
  ...
  en: {
    ...
    profil_donnees_title: 'Privacy', profil_donnees_desc: 'Most of your data stays on your device (sessions, progress, preferences). If you create an account, your email, first name and progress are synced to our Supabase (EU) backend so you can recover your data on another phone. Anonymised crash reports go to Sentry, and subscriptions are handled by RevenueCat/Apple. We do no advertising tracking.', profil_donnees_local: 'Sessions and progress stored locally', profil_donnees_no_tracking: 'No advertising tracking', profil_donnees_healthkit: 'HealthKit: read (HR, calories), write Pilates workouts',
    ...
    paywall_close: 'Close',
    a11y_close_paywall: 'Close paywall',
    a11y_clear_search: 'Clear search',
    profil_signout: 'Sign out',
    coach_modal_close: 'Close',
    profile_edit_close: 'Close',
    error_boundary_title: 'Oops — something went wrong',
    error_boundary_sub: 'Restart the app or reload JavaScript.',
