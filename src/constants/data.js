...
export const T = {
  fr: {
    ...
    referral_stat_months_available: 'mois disponibles',
    referral_explainer: 'Chaque amie qui s\'abonne via ton code te fait gagner 1 mois gratuit — à elle aussi.',
    // Onboarding step (référence : optionnelle, au tout dernier step)
    onb_referral_title: 'Tu as un code de parrainage ?',
    onb_referral_sub: 'Si une amie t\'a donné son code, tu gagnerez chacune 1 mois gratuit dès ton premier abonnement.',
  ...
  en: {
    ...
    referral_stat_months_available: 'months available',
    referral_explainer: 'Each friend who subscribes via your code earns you 1 free month — they get one too.',
    // Onboarding step
    onb_referral_title: 'Do you have a referral code?',
    onb_referral_sub: 'If a friend gave you their code, you\'ll both earn 1 free month when you subscribe.',
