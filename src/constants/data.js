...
export const T = {
  fr: {
    ...
    paywall_guarantee_pill: 'Annule sans frais dans les 7 premiers jours',
    ...
    // Founder pricing — copy positionnée "rejoins les premiers membres".
    paywall_founder_tag: 'PRIX FONDATEUR',
    paywall_founder_banner_sub: 'Économise 200 CHF/an à vie en rejoignant les premiers membres',
    paywall_founder_hero_title: 'Rejoins les fondateurs FluidBody+',
    paywall_founder_hero_sub: 'Le Pilates conscient de Sabrina, sur tous tes écrans. Pour la moitié du prix, à vie.',
    paywall_founder_bullets: [
      { icon: '✨', text: '9 piliers de Pilates conscient — Mat, Mobilité, Posture, Golf, Eldoa, Épaules, Dos, Office, Ménopause' },
      { icon: '🎬', text: 'iPhone + Apple TV inclus dans un seul abonnement' },
      { icon: '👩‍🏫', text: 'Guidé par Sabrina, 30 ans de pratique à Espace Pilates Suisse' },
      { icon: '🌍', text: 'Disponible en français, anglais, espagnol, italien' },
      { icon: '🪼', text: 'Sabrina IA pour personnaliser ta pratique (à venir)' },
    ],
    paywall_founder_cta: 'Commencer 7 jours gratuits',
    paywall_founder_save_pill: (pct) => 'Économise ' + pct + '% à vie',
    paywall_founder_save_pill_static: 'Économise 50% à vie',
    paywall_founder_strikethrough_intro: 'au lieu de',
    paywall_founder_compare_title: 'Comparé au marché',
    paywall_founder_compare_speir: 'Speir · CHF 26.67/mois — Mat uniquement',
    paywall_founder_compare_us: 'FluidBody+ Fondateur · CHF 12.90/mois — 9 piliers + IA',
  ...
  en: {
    ...
    paywall_guarantee_pill: 'Cancel free of charge in the first 7 days',
    ...
    paywall_founder_tag: 'FOUNDER PRICE',
    paywall_founder_banner_sub: 'Save 200 CHF/year for life by joining the first members',
    paywall_founder_hero_title: 'Join the FluidBody+ founders',
    paywall_founder_hero_sub: "Sabrina's conscious Pilates, on every screen. For half the price, for life.",
    paywall_founder_bullets: [
      { icon: '✨', text: '9 pillars of conscious Pilates — Mat, Mobility, Posture, Golf, Eldoa, Shoulders, Back, Office, Menopause' },
      { icon: '🎬', text: 'iPhone + Apple TV included in a single subscription' },
      { icon: '👩‍🏫', text: 'Guided by Sabrina, 30 years of practice at Espace Pilates Suisse' },
      { icon: '🌍', text: 'Available in French, English, Spanish, Italian' },
      { icon: '🪼', text: 'Sabrina AI to personalise your practice (coming soon)' },
    ],
    paywall_founder_cta: 'Start 7 free days',
    paywall_founder_save_pill: (pct) => 'Save ' + pct + '% for life',
    paywall_founder_save_pill_static: 'Save 50% for life',
    paywall_founder_strikethrough_intro: 'instead of',
    paywall_founder_compare_title: 'Compared to the market',
    paywall_founder_compare_speir: 'Speir · CHF 26.67/mo — Mat only',
    paywall_founder_compare_us: 'FluidBody+ Founder · CHF 12.90/mo — 9 pillars + AI',
