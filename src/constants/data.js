...
export const T = {
  fr: {
    ...
    resume_title: 'Résumé', resume_seances: 'Séances FluidBody', resume_no_seance: 'Aucune séance complétée', resume_progression: 'Progression', resume_global: 'Global', resume_streak: 'Streak',
  ...
  en: {
    ...
    resume_title: 'Summary', resume_seances: 'FluidBody Sessions', resume_no_seance: 'No sessions completed', resume_progression: 'Progress', resume_global: 'Overall', resume_streak: 'Streak',
    bonjour: (p) => p ? `Hello ${p}` : '',
    bonjour_mot: 'Hello',
