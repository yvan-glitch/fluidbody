...
function ProfilScreen({ prenom, done, lang, streak, supabase, supaUser, onLogout, onCreateAccount, isSubscriber, isAdmin, onRestorePurchases, onReset, onOpenTimer, onOpenStatistics, onOpenDownloads, onOpenPreferences, onEditProfile, profileRefreshKey, onAccountDeleted }) {
  var tr = T[lang] || T['fr'];
